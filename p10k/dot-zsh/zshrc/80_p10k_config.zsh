# Generated by Powerlevel10k configuration wizard on 2022-12-21 at 12:31 MST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    fnm                     # Fast node manager version (https://github.com/Schniz/fnm)
